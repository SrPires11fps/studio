        ...
        <div className="flex flex-col items-center justify-center space-y-4 text-center">
          <div className="space-y-2">
            ...
            <p className="max-w-[900px] text-foreground/80 md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
              Escolha o melhor plano para você e começe uma nova vida sem dor hoje mesmo.
            </p>
          </div>
        </div>
          ...
          <Card className="border-2 border-primary flex flex-col relative shadow-2xl">
            ...
            <CardContent className="flex-1">
              <div className="mb-4 text-center md:text-left">
                  ...
                  <div className="text-5xl font-bold font-headline">R$37</div>
              ...
              <ul className="grid gap-3 text-sm">
                ...
                <li className="flex items-start gap-2">
                 ...
                 <li className="flex items-start gap-2">
                  <Gift className="h-5 w-5 flex-shrink-0 text-primary" />
                  <span><strong className="font-semibold">Bônus #6:</strong> Guia Completo de Postura</span>
                </li>
                 <li className="flex items-start gap-2">
                  <Gift className="h-5 w-5 flex-shrink-0 text-primary" />
                 ...
                 <li className="flex items-start gap-2">
                  <Gift className="h-5 w-5 flex-shrink-0 text-primary" />
                  <span><strong className="font-semibold">Bônus #8:</strong> Protocolo de Relaxamento para Sono Rápido</span>
                </li>
              </ul>
            </CardContent>
