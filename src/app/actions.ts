...
export async function getTestimonials() {
  try {
    ...
    return [
        ...
        "“Trabalho o dia inteiro sentado e sempre achei que aquela dor nas costas era algo passageiro, que iria sumir sozinha. Mas ela só foi piorando. Começou a afetar meu sono, minha concentração e até meu humor. Resolvi testar o Método Destravamento Instantâneo, e nos primeiros dias já senti a dor diminuir. Na segunda semana, a dor já tinha desaparecido por completo. Os alongamentos são fáceis, rápidos e funcionam de verdade.”",
