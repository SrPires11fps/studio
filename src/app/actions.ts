...
export async function getTestimonials() {
  try {
    ...
    return [
        ...
        "Trabalhei a vida inteira carregando peso e minha lombar virou um problema constante. Cheguei a evitar sair de casa porque qualquer caminhada me travava. Com o Destravamento Instantâneo, o alívio veio rápido. Em poucas semanas a dor sumiu e voltei a caminhar e aproveitar a vida. Os movimentos são fáceis e acabam em menos de 10 minutos."
    ];
  }
}
